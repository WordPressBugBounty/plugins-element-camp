...
class ElementCamp_Button extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'button_alignment',
            [
                'label' => esc_html__('Button Text Alignment', 'element-camp'),
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-button' => 'transform: translate({{button_translate_x.SIZE}}{{button_translate_x.UNIT}},{{button_translate_y.SIZE}}{{button_translate_y.UNIT}})',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-button:hover' => 'transform: translate({{button_translate_x_hover.SIZE}}{{button_translate_x_hover.UNIT}},{{button_translate_y_hover.SIZE}}{{button_translate_y_hover.UNIT}})',
                    '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-button.tc-button-container-active' => 'transform: translate({{button_translate_x_hover.SIZE}}{{button_translate_x_hover.UNIT}},{{button_translate_y_hover.SIZE}}{{button_translate_y_hover.UNIT}})',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => [ 'classic', 'gradient', 'tcg_gradient' ],
                'selector' => '{{WRAPPER}} .tcgelements-button:hover::before',
            ]
        );
        $this->add_responsive_control(
            'hover_before_width',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    '' => esc_html__('Default', 'element-camp'),
                    'text-transform' => esc_html__('Button Text Transform', 'element-camp'),
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render()
    {
        ...
        if ($settings['link_to'] == 'woo-product' && isset($product)) {
            ...
            echo apply_filters(
                ...
                ' class="tcgelements-button product_type_'. esc_attr( $product->get_type() ) . esc_attr($animated_class) .  ($settings['button_transition_switcher'] != 'yes' ? ' transition-none' : '') . ' add_to_cart_button ajax_add_to_cart" '.
                ...
                (isset($settings['button_animations']) && $settings['button_animations'] == 'text-transform'?
                    '<span class="hvr-txt" data-text="'. esc_attr($settings['btn_text']). '">' : '').
            ...
            <?php if ($settings['link_to']=='none') : ?>
                <div <?php if (!empty($btn_id)) echo "id=$btn_id" ?> class="tcgelements-button <?php echo 'btn-selector-type-' . $settings['button_hover_selector'] . ' ' . 'btn-text-selector-type-' . $settings['button_text_hover_selector'] . ' ' . esc_attr($animated_class); if($settings['button_transition_switcher'] != 'yes') echo esc_attr(' transition-none'); ?>" <?php if ($settings['button_hover_selector']=='parent-n' && !empty($settings['parent_level'])) echo 'data-parent-level="' . esc_attr($settings['parent_level']) . '"'; ?>>
            <?php else: ?>
                <a <?php if (!empty($btn_id)) echo "id=$btn_id" ?> href="<?= $url; ?>" <?php if ($settings['link_to']=='custom' && $settings['link']['is_external'] ) {echo'target="_blank"';} ?> class="tcgelements-button <?php echo 'btn-selector-type-' . $settings['button_hover_selector'] . ' ' . 'btn-text-selector-type-' . $settings['button_text_hover_selector'] . ' ' . esc_attr($animated_class); if($settings['button_transition_switcher'] != 'yes') echo esc_attr(' transition-none'); ?>" <?php if ($settings['play_button']=='yes')echo esc_attr('data-lity="video"')?> <?php if ($settings['button_hover_selector']=='parent-n' && !empty($settings['parent_level'])) echo 'data-parent-level="' . esc_attr($settings['parent_level']) . '"'; ?>>
            <?php endif;?>
