...
class ElementCamp_Service_Modern extends Widget_Base {
    ...
    protected function render(){
        ...
        ?>
        <a class="tcgelements-service-modern" href="<?= esc_url($settings['link']['url']) ?>" <?php if ( $settings['link']['is_external'] ) {echo'target="_blank"';} ?>>
            <div class="row">
                <div class="col-lg-1 d-none d-lg-block">
                    <span class="number"><?=esc_html__($settings['service_number'])?></span>
                </div>
