    	...
    	public function enqueue() {
    		...
    		wp_localize_script(
    			...
    			[
    				...
    				'nonce'           => wp_create_nonce( 'tcg_select2_nonce' ),
    				'search_text'     => esc_html__( 'Search', 'element-camp' ),
    				'remove'          => __( 'Remove', 'element-camp' ),
    				'thumbnail'       => __( 'Image', 'element-camp' ),
    				'name'            => __( 'Title', 'element-camp' ),
    				'price'           => __( 'Price', 'element-camp' ),
    				'quantity'        => __( 'Quantity', 'element-camp' ),
    				'subtotal'        => __( 'Subtotal', 'element-camp' ),
    				'cl_login_status' => __( 'User Status', 'element-camp' ),
    				'cl_post_type'    => __( 'Post Type', 'element-camp' ),
    				'cl_browser'      => __( 'Browser', 'element-camp' ),
    				'cl_date_time'    => __( 'Date & Time', 'element-camp' ),
    				'cl_recurring_day'=> __( 'Recurring Day', 'element-camp' ),
    				'cl_dynamic'      => __( 'Dynamic Field', 'element-camp' ),
    				'cl_query_string' => __( 'Query String', 'element-camp' ),
    				'cl_visit_count'  => __( 'Visit Count', 'element-camp' ),
    			]
    		);
