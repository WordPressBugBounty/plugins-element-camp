(function ($) {
    ...
    function elementcamp_testimonials_slider($scope, $) {
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/tcgelements-testimonials-slider.default',elementcamp_testimonials_slider) ;
    });
})(jQuery);
