...
class ElementCamp_Menu_List extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'menu_item_icon',
            [
                'label' => esc_html__('Menu Item Icon', 'element-camp'),
                'type' => Controls_Manager::ICONS,
                'fa4compatibility' => 'icon',
                'skin' => 'inline',
                'label_block' => false,
                'description' => esc_html__('Icon that appears before each menu item text', 'element-camp'),
            ]
        );
        $this->add_control(
            'dropdown_icon',
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'menu_item_link_active_border',
                'selector' => '{{WRAPPER}} .tcgelements-menu-list > div > ul > .current-menu-item a',
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            'dropdown_icon_container_margin',
            [
                'label' => esc_html__('Drop Down Icon Container Margin', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'position: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'position: {{VALUE}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'left: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'left: {{SIZE}}{{UNIT}}',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'right: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'right: {{SIZE}}{{UNIT}}',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'top: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'top: {{SIZE}}{{UNIT}}',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon i' => 'bottom: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .dropdown-icon svg' => 'bottom: {{SIZE}}{{UNIT}}',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em' , 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item .sub-menu a:hover' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Menu Icon', 'element-camp' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            'menu_item_icon_size',
            [
                'label' => esc_html__('Menu Item Icon Size', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'custom', 'rem', 'em'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item a .menu-item-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item a .menu-item-icon svg' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Menu Item Icon Margin', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item a .menu-item-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Menu Item Icon Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item a .menu-item-icon i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-menu-list ul .menu-item a .menu-item-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render() {
        ...
        if (!empty($settings['menu_item_icon'])) {
            ob_start();
            Icons_Manager::render_icon($settings['menu_item_icon'], ['aria-hidden' => 'true']);
