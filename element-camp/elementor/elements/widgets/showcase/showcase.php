...
class ElementCamp_Showcase extends Widget_Base
{
    ...
    {
        return ['swiper','tcgelements-showcase','tcgelements-float-cursor-animation'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_tab(
            'item_odd_tab',
            [
                'label'   => esc_html__( 'Odd', 'element-camp' ),
            ]
        );
        $this->add_responsive_control(
            'item_odd_margin',
            [
                ...
                'size_units' => ['px', '%', 'em', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide:nth-of-type(odd) .item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->end_controls_tab();
        $this->start_controls_tab(
            'image_overlay_card_hover_tab',
            [
                'label'   => esc_html__( 'Card Hover', 'element-camp' ),
            ]
        );
        $this->add_control(
            'image_overlay_transition',
            [
                'label' => esc_html__( 'Image Overlay Transition', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .img::before' => 'transition: all {{SIZE}}s ease;',
                ],
            ]
        );
        $this->add_control(
            'img_overlay_card_hover_opacity',
            [
                'label' => esc_html__( 'Overlay Opacity', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .img::before' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_off' => esc_html__( 'No', 'element-camp' ),
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'content:"";',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info' => '{{VALUE}}: blur({{info_section_blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
            'info_section_blur_value',
            [
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'info_container_box_shadow',
                'selector' => '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info',
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'position_for_info_container_hover',
            [
                'label' => esc_html__( 'Info Container Position', 'element-camp' ),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info' => 'position: {{VALUE}};',
                ],
                'separator' => 'before'
            ]
        );
        $this->add_control(
            'info_container_hover_offset_orientation_h',
            [
                'label' => esc_html__( 'Horizontal Orientation', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                ],
                'condition' => [
                    'info_container_hover_offset_orientation_h' => 'start',
                    'position_for_info_container_hover!' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            'info_container_hover_offset_x_end',
            [
                'label' => esc_html__( 'Offset', 'element-camp' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                ],
                'condition' => [
                    'info_container_hover_offset_orientation_h' => 'end',
                    'position_for_info_container_hover!' => '',
                ],
            ]
        );
        $this->add_control(
            'info_container_hover_offset_orientation_v',
            [
                'label' => esc_html__( 'Vertical Orientation', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info' => 'top: {{SIZE}}{{UNIT}}',
                ],
                'condition' => [
                    'info_container_hover_offset_orientation_v' => 'start',
                    'position_for_info_container_hover!' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            'info_container_hover_offset_y_end',
            [
                'label' => esc_html__( 'Offset', 'element-camp' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info' => 'bottom: {{SIZE}}{{UNIT}}',
                ],
                'condition' => [
                    'info_container_hover_offset_orientation_v' => 'end',
                    'position_for_info_container_hover!' => '',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        \Elementor\Group_Control_Background::get_type(),
            [
                ...
                'selector' => '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after',
                'types' => [ 'classic', 'gradient', 'tcg_gradient' ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => 'absolute',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'position: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                ],
                'condition' => [
                    'info_overlay_offset_orientation_h' => 'end',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'bottom: {{SIZE}}{{UNIT}}; top: unset;',
                ],
                'condition' => [
                    'info_overlay_offset_orientation_v' => 'end',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info::after' => 'clip-path: {{VALUE}}({{info_overlay_clip_path_value.VALUE}});',
                ],
            ]
        );

        $this->add_control(
            'info_overlay_clip_path_value',
            [
                ...
                'frontend_available' => true,
                'condition' => [
                    'info_overlay_clip_path' => ['circle', 'ellipse', 'inset', 'polygon'],
                ],
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'title_card_hover_typography',
                'label' => esc_html__('Title', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info .title,{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .copy-info .title',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .info .title' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item:hover .copy-info .title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info .taxonomy' => 'display: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .copy-info .taxonomy' => 'display: {{VALUE}};'
                ]
            ]
        );
        $this->add_responsive_control(
            'taxonomy_wrapper_text_align',
            [
                'label' => esc_html__( 'Text Alignment', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info .taxonomy' => 'text-align: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .copy-info .taxonomy' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'fields_options' => [
                    'background' => [
                        'label' => esc_html_x('Taxonomy Wrapper Background', 'Background Control', 'element-camp'),
                    ]
                ],
                'types' => [ 'classic', 'gradient', 'tcg_gradient' ],
                'selector' => '{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .info .taxonomy,{{WRAPPER}} .tcgelements-showcase .swiper-container .swiper-slide .item .copy-info .taxonomy',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'absolute',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar' => 'position: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'position: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                ],
                'condition' => [
                    'progressbar_offset_orientation_h' => 'end',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                    '{{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar' => 'bottom: {{SIZE}}{{UNIT}}; top: unset;',
                    '{{WRAPPER}} .tcgelements-showcase .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'bottom: {{SIZE}}{{UNIT}}; top: unset;',
                ],
                'condition' => [
                    'progressbar_offset_orientation_v' => 'end',
                ],
                                    ...
                                    <div class="info <?php if ($settings['info_animations']=='duplicate') echo esc_attr('info-duplicate')?>">
                                        ...
                                        <?php endif;?>
                                                ...
                                                if ($settings['display_terms'] === 'yes' &&
                                                    (($selected_term_type === 'categories' && !empty($category)) ||
                                                        ($selected_term_type === 'tags' && !empty($tags)))) :
                                                    ?>
