...
class ElementCamp_Gallery_Slider extends Widget_Base
{
    ...
    {
        return ['swiper','swiper-panorama','tcgelements-gallery-slider'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'slides_transform_important',
            [
                'label' => esc_html__('Force Transform Styles', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'element-camp'),
                'label_off' => esc_html__('No', 'element-camp'),
                'return_value' => 'yes',
                'default' => 'yes',
                'description' => esc_html__('Use !important for transform styles. Disable this if using Coverflow effect or if transforms conflict with other effects.', 'element-camp'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'panorama' => esc_html__('Panorama', 'element-camp'),
                ],
                'label_block' => true,
                'default' => 'slide',
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'effect!' => ['slide', 'coverflow', 'panorama']
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Coverflow Rotate', 'element-camp'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 360,
                'step' => 1,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Coverflow Stretch', 'element-camp'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 500,
                'step' => 1,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Coverflow Depth', 'element-camp'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 1000,
                'step' => 10,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Coverflow Modifier', 'element-camp'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 10,
                'step' => 0.1,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Coverflow Slide Shadows', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'panoramaDepth',
            [
                'label' => esc_html__('Panorama Depth', 'element-camp'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 50,
                'max' => 1000,
                'step' => 10,
        ...
        $this->add_control(
            'panoramaRotate',
            [
                'label' => esc_html__('Panorama Rotate', 'element-camp'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 90,
                'step' => 1,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Transition Timing Function', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'linear' => esc_html__('Linear', 'element-camp'),
                    'ease' => esc_html__('Ease', 'element-camp'),
                ],
                'label_block' => true,
                'default' => 'ease',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-wrapper' => 'transition-timing-function: {{VALUE}};',
                ],
                'condition' => [
                    'effect' => 'panorama',
                ]
        ...
        $repeater->add_control(
            'panorama_heading',
            [
                'label' => esc_html__('Panorama Effect Settings', 'element-camp'),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'max' => 1000,
                'step' => 10,
                'description' => esc_html__('Only applies when Panorama effect is selected', 'element-camp'),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-container' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Slides Style', 'element-camp'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-slide' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-slide' => 'transition-duration: {{SIZE}}s',
                ],
            ]
        );
        $this->start_controls_tabs('slides_tabs');
        ...
        $this->start_popover();
        $this->add_control(
            'slider_prev_slide_scale',
            [
                'label' => esc_html__('Scale', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-slide.swiper-slide-prev' => '--e-transform-tcgelements-gallery-slider-slide-scale: {{SIZE}}',
                ],
            ]
        );
        $this->end_popover();
        ...
        $this->start_popover();
        $this->add_control(
            'slider_active_slide_scale',
            [
                'label' => esc_html__('Scale', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-slide.swiper-slide-active' => '--e-transform-tcgelements-gallery-slider-slide-scale: {{SIZE}}',
                ],
            ]
        );
        $this->end_popover();
        ...
        $this->start_popover();
        $this->add_control(
            'slider_next_slide_scale',
            [
                'label' => esc_html__('Scale', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-slide.swiper-slide-next' => '--e-transform-tcgelements-gallery-slider-slide-scale: {{SIZE}}',
                ],
            ]
        );
        $this->end_popover();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item' => 'justify-content: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item' => 'align-items: {{VALUE}};',
                ],
                'condition'=> ['item_display'=> ['flex','inline-flex']],
                'responsive' => true,
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item' => 'transition: all {{SIZE}}s ease;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tcgelements-gallery-slider .item',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item ' => '{{VALUE}}: blur({{item_blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient', 'tcg_gradient'],
                'selector' => '{{WRAPPER}} .tcgelements-gallery-slider .item:hover',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item:hover' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->add_control(
            'item_hover_blur_method',
            [
                'label' => esc_html__('Blur Method', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                ...
                'default' => 'backdrop-filter',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item:hover' => '{{VALUE}}: blur({{item_hover_blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
            'item_hover_blur_value',
            [
                'label' => esc_html__('Blur', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item' => 'transition-duration: {{SIZE}}s',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .item img' => 'transition: all {{SIZE}}s ease;',
                ],
            ]
        );
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'Visible',
            [
                'label' => esc_html__( 'Visible Swiper Slide', 'element-camp' ),
            ]
        );

        $this->add_control(
            'opacity_visible_swiper_slider',
            [
                'label' => esc_html__( 'Opacity', 'element-camp' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-slide-visible .item img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'object-position_visible_swiper_slide',
            [
                'label' => esc_html__( 'Object Position', 'element-camp' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                ...
                'default' => 'center center',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .swiper-slide-visible .item img' => 'object-position: {{VALUE}};',
                ],
                'condition' => [
                    'height[size]!' => '',
                    'object-fit' => 'cover',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .tce-float-cursor' => 'width: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .tce-float-cursor' => 'height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .tcgelements-gallery-slider .tce-float-cursor .icon i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-gallery-slider .tce-float-cursor .icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tcgelements-gallery-slider .tce-float-cursor',
                'types' => [ 'classic', 'gradient', 'tcg_gradient' ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-gallery-slider .tce-float-cursor .icon' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .tcgelements-gallery-slider .tce-float-cursor .icon svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
    ...
    protected function render() {
        ...
        foreach ($settings['responsive_settings'] as $item) {
            $breakpoint_settings = [
                'slidesPerView' => $item['slidesPerView_auto'] === 'true' ? 'auto' : (int)$item['slidesPerView'],
                'spaceBetween' => (int)$item['spaceBetween'],
            ];
            if ($settings['effect'] === 'panorama') {
                $panorama_effect = [];

                if (array_key_exists('panoramaDepth', $item) && $item['panoramaDepth'] !== '') {
                    $panorama_effect['depth'] = (int)$item['panoramaDepth'];
                }

                if (array_key_exists('panoramaRotate', $item) && $item['panoramaRotate'] !== '') {
                    $panorama_effect['rotate'] = (int)$item['panoramaRotate'];
                }

                if (!empty($panorama_effect)) {
                    $breakpoint_settings['panoramaEffect'] = $panorama_effect;
                }
            }

            $responsive_settings[$item['breakpoint']] = $breakpoint_settings;
        }
        ...
        $slider_settings = [
            ...
            'panoramaDepth' => $settings['panoramaDepth'],
            'panoramaRotate' => $settings['panoramaRotate'],
            'coverflowRotate' => isset($settings['coverflowEffect_rotate']) ? $settings['coverflowEffect_rotate'] : 50,
            'coverflowStretch' => isset($settings['coverflowEffect_stretch']) ? $settings['coverflowEffect_stretch'] : 0,
            'coverflowDepth' => isset($settings['coverflowEffect_depth']) ? $settings['coverflowEffect_depth'] : 100,
            'coverflowModifier' => isset($settings['coverflowEffect_modifier']) ? $settings['coverflowEffect_modifier'] : 1,
            'coverflowSlideShadows' => isset($settings['coverflowEffect_slideShadows']) ? $settings['coverflowEffect_slideShadows'] : 'true',
        ];

        // Add autoplay settings if enabled
        ...
        $force_transform_class = ($settings['slides_transform_important'] !== 'yes') ? ' disable-force-transform' : '';
        $cursor_class = $settings['float_cursor'] === 'true' ? ' tce-float-cursor-container' : '';
        $parallax_class = $settings['effect'] == 'parallax' ? 'tcg-dynamic-parallax-slider' : '';
        ?>

    <div id="<?php echo esc_attr($max_slider_id) ?>"
         class="tcgelements-gallery-slider<?php echo esc_attr($cursor_class . $force_transform_class); ?>"
         data-tcgelements-gallery-slider='<?php echo esc_attr(json_encode($slider_settings)); ?>'>
        <div class="swiper-container <?php echo esc_attr($parallax_class); ?>">
            <div class="swiper-wrapper">
                <?php foreach ($settings['tcg_dynamic_slides_repeater'] as $slide) :
                $is_linked = isset($slide['link_type']) && $slide['link_type'] === 'custom' && !empty($slide['link']['url']);
                $target = $is_linked && $slide['link']['is_external'] ? 'target="_blank"' : '';
                $img_alt = !empty($slide['image']['alt']) ? esc_attr($slide['image']['alt']) : '';
                $has_icon = !empty($slide['selected_icon']['value']);
                ?>
            ...
            <?php if($settings['float_cursor'] === 'true'): ?>
                <div class="tce-float-cursor">
                    <span class="icon"><?php \Elementor\Icons_Manager::render_icon($settings['float_cursor_icon'], ['aria-hidden' => 'true']); ?></span>
                </div>
            <?php endif; ?>
        </div>
        <?php
