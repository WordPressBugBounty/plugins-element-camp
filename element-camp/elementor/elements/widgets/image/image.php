...
class ElementCamp_Image extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Widget Wrapper Height', 'element-camp'),
        ...
        $this->add_responsive_control(
            'elementor_widget_container_display',
            [
                'label' => esc_html__('Container Display', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                'options' => [
        ...
        $this->add_responsive_control(
            'elementor_widget_container_justify_content',
            [
                ...
                'condition' => [
                    'elementor_widget_container_display' => ['flex', 'inline-flex']
                ],
                'responsive' => true,
            ]
        );
        $this->add_responsive_control(
            'elementor_widget_container_align_items',
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'image_container_outline_type!' => ['', 'none'],
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image' => 'outline-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image' => 'outline-color: {{VALUE}};',
                ],
                'condition' => [
                    'image_container_outline_type!' => ['', 'none'],
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image' => 'outline-offset: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image img ' => '{{VALUE}}: blur({{image_blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'parent-n'  => esc_html__('Parent N Level', 'element-camp'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 1,
                'condition' => [
                    'image_hover_overlay_selector' => 'parent-n',
                ],
                'description' => esc_html__('Set how many levels up to target the parent element', 'element-camp'),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image::after' => 'left: {{SIZE}}{{UNIT}}; right:unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image::after' => 'right: {{SIZE}}{{UNIT}}; left:unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image::after' => 'top: {{SIZE}}{{UNIT}}; bottom:unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image::after' => 'bottom: {{SIZE}}{{UNIT}}; top:unset;',
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'backdrop-filter',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image .image-hover-container a ' => '{{VALUE}}: blur({{blur_value.SIZE}}px);',
                    '{{WRAPPER}} .tcgelements-image .tc-hover-media' => '{{VALUE}}: blur({{blur_value.SIZE}}px);',
                    '{{WRAPPER}} .tcgelements-image .image-hover-container .tcgelements-float-cursor .icon' => '{{VALUE}}: blur({{blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            Group_Control_Css_Filter::get_type(),
            [
                'name' => 'image_on_container_hover_css_filters',
                'selector' => '{{WRAPPER}} .tcgelements-image img',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-image' => 'transform:  rotate({{image_hover_rotate.SIZE}}deg) translate({{image_hover_translate_x.SIZE}}{{image_hover_translate_x.UNIT}},{{image_hover_translate_y.SIZE}}{{image_hover_translate_y.UNIT}}) scale({{image_hover_scale.SIZE}})',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            'img_container_width_on_container_hover',
            [
                ...
                'selectors' => [
                    '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-image.selector-type-container.tcgelements-image-container-active' => 'width: {{SIZE}}{{UNIT}};',
                    '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-image.tcgelements-image-container-active' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'widget_wrapper_height_on_container_hover',
            [
                'label' => esc_html__('Widget Wrapper Height', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                ...
                'selectors' => [
                    '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-image.selector-type-container.tcgelements-image-container-active' => 'height: {{SIZE}}{{UNIT}};',
                    '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-image.tcgelements-image-container-active ' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            Group_Control_Css_Filter::get_type(),
            [
                'name' => 'image_on_container_hover_css_filters_hover',
                'selector' =>
                '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-image.tcgelements-image-container-active img',
            ]
        );
        $this->add_control(
            'custom_css_filter_on_container_hover_popover',
            [
                'label' => esc_html__('Custom CSS Filter', 'element-camp'),
                'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
                'label_off' => esc_html__('Default', 'element-camp'),
        ...
        $this->start_popover();
        $this->add_control(
            'filter_invert_on_container_hover',
            [
                'label' => esc_html__( 'Invert', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
        ...
        $this->add_control(
            'filter_sepia_on_container_hover',
            [
                'label' => esc_html__( 'Sepia', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
        ...
        $this->add_control(
            'filter_saturate_on_container_hover',
            [
                'label' => esc_html__( 'Saturate', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
        ...
        $this->add_control(
            'filter_hue_rotate_on_container_hover',
            [
                'label' => esc_html__( 'Hue Rotate', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ 'deg' ],
        ...
        $this->add_control(
            'filter_brightness_on_container_hover',
            [
                'label' => esc_html__( 'Brightness', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
        ...
        $this->add_control(
            'filter_contrast_on_container_hover',
            [
                'label' => esc_html__( 'Contrast', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
        ...
        $this->add_responsive_control(
            'image_on_container_hover_scale_hover',
            [
                'label' => esc_html__('Scale', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-image.selector-type-container.tcgelements-image-container-active' => 'transform:  rotate({{image_on_container_hover_rotate_hover.SIZE}}deg) translate({{image_on_container_hover_translate_x_hover.SIZE}}{{image_on_container_hover_translate_x_hover.UNIT}},{{image_on_container_hover_translate_y_hover.SIZE}}{{image_on_container_hover_translate_y_hover.UNIT}}) scale(image_on_container_hover_scale_hover.SIZE)',
                    '.e-con:hover .elementor-element-{{ID}}>.elementor-widget-container>.tcgelements-image.tcgelements-image-container-active' => 'transform:  rotate({{image_on_container_hover_rotate_hover.SIZE}}deg) translate({{image_on_container_hover_translate_x_hover.SIZE}}{{image_on_container_hover_translate_x_hover.UNIT}},{{image_on_container_hover_translate_y_hover.SIZE}}{{image_on_container_hover_translate_y_hover.UNIT}}) scale({{image_on_container_hover_scale_hover.SIZE}})',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Mouse Parallax Speed', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'parallax_mode',
            [
                'label' => esc_html__('Parallax Mode', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'default' => 'global',
                'options' => [
                    'global' => esc_html__('Global (Full Page)', 'element-camp'),
                    'container' => esc_html__('Container Based', 'element-camp'),
                ],
                'condition' => [
                    'image_animations' => 'tce-mouse-parallax',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'horizontal-only' => esc_html__('Horizontal Only', 'element-camp'),
                    'vertical-only' => esc_html__('Vertical Only', 'element-camp'),
                ],
                'condition' => [
                    'image_animations' => 'tce-mouse-parallax',
                    'parallax_mode' => 'global',
                ],
            ]
        );

// Container mode specific controls
        $this->add_control(
            'container_parallax_intensity',
            [
                'label' => esc_html__('Base Intensity', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.1,
        ...
        $this->add_control(
            'container_parallax_range',
            [
                'label' => esc_html__('Movement Range', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'container_parallax_scale_factor',
            [
                'label' => esc_html__('Scale Factor', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.05,
    ...
    protected function render()
    {
        ...
        $parallax_speed = 0.3;
        if (!empty($settings['mouse_parallax_speed']['size'])) {
            $parallax_speed = $settings['mouse_parallax_speed']['size'];
        }
        $parallax_mode = !empty($settings['parallax_mode']) ? $settings['parallax_mode'] : 'global';
        $container_class = ($parallax_mode === 'container') ? ' parallax-container' : '';
        $container_intensity = !empty($settings['container_parallax_intensity']['size']) ? $settings['container_parallax_intensity']['size'] : 0.4;
        $container_range = !empty($settings['container_parallax_range']['size']) ? $settings['container_parallax_range']['size'] : 50;
        ...
        <div class="tcgelements-image <?php echo 'selector-type-' . esc_attr($settings['image_hover_overlay_selector']) ?><?php echo esc_attr($container_class); ?> <?php if (!empty($settings['image_animations'])) echo esc_attr($settings['image_animations']) ?> <?php if ($settings['rotate_animation_reverse'] === 'yes') echo esc_attr("reverse"); ?><?php if ($settings['image_hover_overlay_content'] === 'float-cursor') echo ' ' . esc_attr("tcgelements-float-cursor-container"); ?><?php if ($parallax_mode === 'container') echo ' parallaxed'; ?>"
            ...
            <?php if ($settings['image_animations'] === 'tce-mouse-parallax') : ?>
                ...
                <?php if ($parallax_mode === 'container') : ?>
                    ...
                    data-parallax-scale-factor="<?php echo esc_attr($container_scale_factor); ?>"
                <?php endif; ?>
            <?php endif; ?>>
