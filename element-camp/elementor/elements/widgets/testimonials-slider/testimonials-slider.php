...
class ElementCamp_Testimonials_Slider extends Widget_Base
{
    ...
    {
        return ['swiper', 'tcgelements-testimonials-slider'];
    }
    ...
    protected function register_controls()
    {
        ...
        $slides_repeater->add_control(
            'quote_text_image_position',
            [
                'label' => esc_html__('Quote Image Position', 'element-camp'),
        ...
        $slides_repeater->add_control(
            'author_image_icon',
            [
                'label' => esc_html__('Author Image Icon', 'element-camp'),
                'type' => Controls_Manager::ICONS,
                'skin' => 'inline',
                'label_block' => false,
            ]
        ...
        $slides_repeater->add_control(
            'additional_link',
            [
                'label' => esc_html__('Additional Link Switcher', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('yes', 'element-camp'),
                'label_off' => esc_html__('No', 'element-camp'),
            ]
        ...
        $slides_repeater->add_control(
            ...
            [
                'label' => esc_html__('Additional Link Text', 'element-camp'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
        ...
        $slides_repeater->add_control(
            'additional_link_url',
            [
                'label' => esc_html__('Additional Link URL', 'element-camp'),
        ...
        $slides_repeater->add_control(
            'additional_quote_footer',
            [
                'label' => esc_html__('Additional Quote Footer', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('yes', 'element-camp'),
                'label_off' => esc_html__('No', 'element-camp'),
                'default' => 'no',
        ...
        $slides_repeater->add_control(
            'icon_footer',
            [
                'label' => esc_html__('Quote Icon Footer', 'element-camp'),
                'type' => Controls_Manager::ICONS,
                'default' => [
                    'value' => 'fa fa-star',
                    'library' => 'fa-solid',
                ],
                'condition' => ['additional_quote_footer' => 'yes'],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .swiper-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .swiper-container' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .swiper-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'testimonials_card_margin',
            [
                'label' => esc_html__('Card Margin', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'after'
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'testimonials_card_box_shadow',
                'selector' => '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card',
            ]
        );
        ...
        $this->add_responsive_control(
            'rate_container_width',
            [
                'label' => esc_html__('Rate Container Width', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .rate' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .rate' => '{{VALUE}}',
                ],
                'condition' => ['rate_container_display' => ['flex', 'inline-flex']],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .rate' => 'justify-content: {{VALUE}};',
                ],
                'condition' => ['rate_container_display' => ['flex', 'inline-flex']],
                'responsive' => true,
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .rate' => 'align-items: {{VALUE}};',
                ],
                'condition' => ['rate_container_display' => ['flex', 'inline-flex']],
                'responsive' => true,
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text' => 'text-wrap: {{VALUE}};'
                ]
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'quote_text_color_dark_mode',
            [
                'label' => esc_html__('Text Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text' => 'color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'quote_text_span_style',
            [
                'label' => esc_html__('Quote Text Span Style', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_responsive_control(
            'quote_text_span_display',
            [
                'label' => esc_html__('Quote Inner Text Display Type', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text span' => 'display: {{VALUE}};'
                ]
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'quote_text_span_typography',
                'label' => esc_html__('Quote Text Span', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text span',
            ]
        );
        $this->add_control(
            'quote_text_span_color',
            [
                'label' => esc_html__('Quote Text Span', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text span' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'quote_inner_text_options',
            [
                'label' => esc_html__('Quote Inner Text Options', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        $this->add_responsive_control(
            'quote_inner_text_display',
            [
                'label' => esc_html__('Quote Inner Text Display Type', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'default' => 'block',
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text .text' => 'display: {{VALUE}};'
                ]
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'unset',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text img' => 'position: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'quote_text_image_offset_orientation_h',
            [
                'label' => esc_html__('Horizontal Orientation', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
                ...
                'render_type' => 'ui',
                'condition' => [
                    'quote_text_image_positioning!' => 'unset',
                ],
            ]
        );

        $this->add_responsive_control(
            'quote_text_image_offset_x',
            [
                'label' => esc_html__('Offset', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text img' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text img' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                ],
                'condition' => [
                    'quote_text_image_positioning!' => 'unset',
                    'quote_text_image_offset_orientation_h!' => 'end',
                ],
            ]
        );

        $this->add_responsive_control(
            'quote_text_image_offset_x_end',
            [
                'label' => esc_html__('Offset', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text img' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text img' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                ],
                'condition' => [
                    'quote_text_image_positioning!' => 'unset',
                    'quote_text_image_offset_orientation_h' => 'end',
        ...
        $this->add_control(
            'quote_text_image_offset_orientation_v',
            [
                'label' => esc_html__('Vertical Orientation', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text img' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                ],
                'condition' => [
                    'quote_text_image_positioning!' => 'unset',
                    'quote_text_image_offset_orientation_v!' => 'end',
                ],
            ]
        );

        $this->add_responsive_control(
            'quote_text_image_offset_y_end',
            [
                'label' => esc_html__('Offset', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .quote-text img' => 'bottom: {{SIZE}}{{UNIT}}; top: unset;',
                ],
                'condition' => [
                    'quote_text_image_positioning!' => 'unset',
                    'quote_text_image_offset_orientation_v' => 'end',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            'author_container_display_position',
            [
                'label' => esc_html__('Card Display Position', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper' => '{{VALUE}}',
                ],
        ...
        $this->add_control(
            'author_container_dark_mode_style',
            [
                'label' => esc_html__('Dark Mode', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_control(
            'author_container_color_dark_mode',
            [
                'label' => esc_html__('Border Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper' => 'border-color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'author_name_position_display',
            [
                'label' => esc_html__('Name And Position Container Display Type', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'default' => 'block',
                'separator' => 'before',
                'options' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .cont' => 'display: {{VALUE}};'
                ],
            ]
        );
        $this->add_responsive_control(
            'author_name_position_display_position',
            [
                'label' => esc_html__('Name And position Display Position', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'before' => [
                        'title' => esc_html__('Before', 'element-camp'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .cont' => '{{VALUE}}',
                ],
                'condition' => ['author_name_position_display' => ['flex', 'inline-flex']],
            ]
        );
        $this->add_responsive_control(
            'author_name_position_justify_content',
            [
                'label' => esc_html__('Justify Content', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => true,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .cont' => 'justify-content: {{VALUE}};',
                ],
                'condition' => ['author_name_position_display' => ['flex', 'inline-flex']],
                'responsive' => true,
            ]
        ...
        $this->add_responsive_control(
            'author_name_position_align_items',
            [
                'label' => esc_html__('Align Items', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'default' => '',
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .cont' => 'align-items: {{VALUE}};',
                ],
                'condition' => ['author_name_position_display' => ['flex', 'inline-flex']],
                'responsive' => true,
            ]
        ...
        $this->add_control(
            'author_name_display',
            [
                'label' => __('Display', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => __('Default', 'element-camp'),
                    'inline-block' => __('Inline Block', 'element-camp'),
                    'inline' => __('Inline', 'element-camp'),
                    'block' => __('Block', 'element-camp'),
                    'none' => __('None', 'element-camp'),
                ],
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-name' => 'display: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'author_name_color_dark_mode',
            [
                'label' => esc_html__('Text Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-name' => 'color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-name' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'author_name_span_typography',
                'label' => esc_html__('Author Name Span', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-name span',
            ]
        );
        $this->add_control(
            'author_name_span_color',
            [
                'label' => esc_html__('Author Name Span Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-name span' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'author_name_span_margin',
            [
                'label' => esc_html__('Author Name Span Margin', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-name span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'author_position_dark_mode_style',
            [
                'label' => esc_html__('Dark Mode', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_control(
            'author_position_color_dark_mode',
            [
                'label' => esc_html__('Text Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-position' => 'color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-position' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'author_position_span_style',
            [
                'label' => esc_html__('Author Position Span Style', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'author_postion_span_typography',
                'label' => esc_html__('Author Name Span', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-position span',
            ]
        );
        $this->add_control(
            'author_postion_span_color',
            [
                'label' => esc_html__('Author Position Span Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-position span' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'author_position_span_margin',
            [
                'label' => esc_html__('Author Position Span Margin', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-position span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Author Image Style', 'element-camp'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'author_container_image_display',
            [
                'label' => __('Display', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-image' => 'display: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .author-image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before'
            ]
        );
        ...
        $this->start_controls_section(
            'section_author_icon_style',
            [
                'label' => __('Author Icon Style', 'element-camp'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'author_icon_wrapper_style_heading',
            [
                'label'     => esc_html__('Icon Wrapper Style', 'element-camp'),
                'type'      => Controls_Manager::HEADING,
            ]
        );

        $this->add_control(
            'author_icon_wrapper_positioning',
            [
                'label' => esc_html__('Position', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                ...
                'default' => 'unset',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'position: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'author_icon_wrapper_offset_orientation_h',
            [
                'label' => esc_html__('Horizontal Orientation', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
                ...
                'render_type' => 'ui',
                'condition' => [
                    'author_icon_wrapper_positioning!' => 'unset',
                ],
            ]
        );

        $this->add_responsive_control(
            'author_icon_wrapper_offset_x',
            [
                'label' => esc_html__('Offset', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                ],
                'condition' => [
                    'author_icon_wrapper_positioning!' => 'unset',
                    'author_icon_wrapper_offset_orientation_h!' => 'end',
                ],
            ]
        );

        $this->add_responsive_control(
            'author_icon_wrapper_offset_x_end',
            [
                'label' => esc_html__('Offset', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                ],
                'condition' => [
                    'author_icon_wrapper_positioning!' => 'unset',
                    'author_icon_wrapper_offset_orientation_h' => 'end',
        ...
        $this->add_control(
            'author_icon_wrapper_offset_orientation_v',
            [
                'label' => esc_html__('Vertical Orientation', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                ],
                'condition' => [
                    'author_icon_wrapper_positioning!' => 'unset',
                    'author_icon_wrapper_offset_orientation_v!' => 'end',
                ],
            ]
        );

        $this->add_responsive_control(
            'author_icon_wrapper_offset_y_end',
            [
                'label' => esc_html__('Offset', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'bottom: {{SIZE}}{{UNIT}}; top: unset;',
                ],
                'condition' => [
                    'author_icon_wrapper_positioning!' => 'unset',
                    'author_icon_wrapper_offset_orientation_v' => 'end',
        ...
        $this->add_responsive_control(
            'author_icon_wrapper_z_index',
            [
                'label' => esc_html__('Z-Index', 'element-camp'),
                'type' => Controls_Manager::NUMBER,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'z-index: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'author_icon_wrapper_display',
            [
                'label' => __('Display', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'inline-block' => __('Inline Block', 'element-camp'),
                    'inline' => __('Inline', 'element-camp'),
                    'inline-flex' => __('Inline Flex', 'element-camp'),
                    'block' => __('Block', 'element-camp'),
                    'none' => __('None', 'element-camp'),
                ],
                'default' => 'inline-block',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'display: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'author_icon_wrapper_justify_content',
            [
                'label' => esc_html__('Justify Content', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => true,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'justify-content: {{VALUE}};',
                ],
                'condition' => ['author_icon_wrapper_display' => ['flex', 'inline-flex']],
                'responsive' => true,
            ]
        );
        $this->add_responsive_control(
            'author_icon_wrapper_align_items',
            [
                'label' => esc_html__('Align Items', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'default' => '',
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'align-items: {{VALUE}};',
                ],
                'condition' => ['author_icon_wrapper_display' => ['flex', 'inline-flex']],
                'responsive' => true,
            ]
        ...
        $this->add_control(
            'author_icon_wrapper_text_align',
            [
                'label' => __('Text Align', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'element-camp'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __('Center', 'element-camp'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __('Right', 'element-camp'),
                        'icon' => 'eicon-text-align-right',
                    ],
                ],
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'author_icon_wrapper_width',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'author_icon_wrapper_height',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'author_icon_wrapper_background',
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon',
            ]
        );
        $this->add_control(
            'author_icon_wrapper_border_radius',
            [
                'label' => __('Border Radius', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name'           => 'author_icon_wrapper_border',
                'selector'       => '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon',
                'separator'  => 'before',
            ]
        );
        $this->add_control(
            'author_icon_style_heading',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .icon svg' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            'quote_icon_footer_style',
            [
                'label' => esc_html__('Quote Icon Footer Style', 'element-camp'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_responsive_control(
            'quote_icon_footer_margin',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'quote_icon_footer_wrapper_z_index',
            [
                'label' => esc_html__('Z-Index', 'element-camp'),
                'type' => Controls_Manager::NUMBER,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon' => 'z-index: {{VALUE}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'quote_icon_footer_wrapper_width',
            [
                'label' => esc_html__('Width', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'quote_icon_footer_wrapper_height',
            [
                'label' => esc_html__('Width', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'quote_icon_footer_color',
            [
                'label' => __('Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'quote_icon_footer_size',
            [
                'label'      => esc_html__('Icon Size', 'element-camp'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                ...
                'selectors'  => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .footer-icon svg' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'additional_link_style',
            [
                'label' => esc_html__('Additional Link Style', 'element-camp'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
            ...
            [
                'name' => 'additional_link_typography',
                'global' => [
                    'default' => Global_Typography::TYPOGRAPHY_ACCENT,
                ],
                'selector' => '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .additional-link',
            ]
        );
        $this->add_control(
            'additional_link_color',
            [
                'label' => esc_html__('Text Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'global' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .additional-link' => 'color: {{VALUE}}; fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'additional_link__margin',
            [
                'label' => esc_html__('Button Margin', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .testi-card .author-wrapper .additional-link' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .tcgelements-testimonials-slider-arrow-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'arrows_style' => ['text', 'text-icon'],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .tcgelements-testimonials-slider-arrows' => '--e-transform-tcgelements-testimonials-slider-arrows-translateX: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .tcgelements-testimonials-slider-arrows' => '--e-transform-tcgelements-testimonials-slider-arrows-translateY: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->end_popover();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vw', 'vh', 'custom'],
                'selectors' => [
                    'body:not(.rtl) {{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'right: {{SIZE}}{{UNIT}}; left: unset;',
                    'body.rtl {{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'left: {{SIZE}}{{UNIT}}; right: unset;',
                ],
                'condition' => [
                    'pagination_progress_bar_offset_orientation_h' => 'end',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'top: {{SIZE}}{{UNIT}}; bottom: unset;',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'vh', 'vw', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-progressbar.swiper-pagination-horizontal' => 'bottom: {{SIZE}}{{UNIT}}; top: unset;',
                ],
                'condition' => [
                    'pagination_progress_bar_offset_orientation_v' => 'end',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-bullets' => 'border-color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcgelements-testimonials-slider .swiper-pagination-bullets' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .arrows-pagination-container' => '{{VALUE}}: blur({{arrows_pagination_container_blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .arrows-pagination-container' => '--e-transform-tcgelements-testimonials-slider-arrows-pagination-container-translateX: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .arrows-pagination-container' => '--e-transform-tcgelements-testimonials-slider-arrows-pagination-container-translateY: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->end_popover();
        ...
        $this->start_controls_section(
            'section_swiper_notification',
            [
                'label' => __('Swiper Notification', 'element-camp'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );

         $this->add_responsive_control(
            'swiper_notification_display',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-testimonials-slider .swiper-notification' => 'display: {{VALUE}};',
                ]
            ]
        );
    ...
    protected function render()
    {
        ...
        $max_slider_id = uniqid('tcgelements-testimonials-slider-', true);

        $cards_per_slide = isset($settings['cards_per_slide']) ? (int)$settings['cards_per_slide'] : 1;
        $testimonials_array = array();

        foreach ($settings['tcg_dynamic_slides_repeater'] as $slide) {
            $testimonials_array[] = $slide;
        }

        $slides = array_chunk($testimonials_array, $cards_per_slide);
        ...
        <div id="<?php echo esc_attr($max_slider_id) ?>" class="tcgelements-testimonials-slider" data-tcgelements-testimonials-slider='<?php echo esc_attr(json_encode($slider_settings)); ?>'>
            <div class="swiper-container <?php if ($settings['effect'] == 'parallax') echo esc_attr('tcg-dynamic-parallax-slider'); ?>">
                <div class="swiper-wrapper">
                    <?php foreach ($slides as $slide_testimonials) : ?>
                        <div class="swiper-slide">
                            <div class="tcgelements-testimonials-slide-container">
                                <?php foreach ($slide_testimonials as $slide) : ?>
                                    <div class="testi-card elementor-repeater-item-<?php echo esc_attr($slide['_id']); ?>">
                                        ...
                                        <?php endif; ?>
                                        <?php if (!empty($slide['author_image']['url']) || !empty($slide['author_image_icon']['value']) || !empty($slide['author_name']) || !empty($slide['author_position']) || $slide['additional_link'] === 'yes') : ?>
                                            <div class="author-wrapper">
                                                ...
                                                <?php if (!empty($slide['icon_footer']['value'])) : ?>
                                                    <span class="footer-icon"> <?php {
                                                                                    Icons_Manager::render_icon($slide['icon_footer']);
                                                                                } ?> </span>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
