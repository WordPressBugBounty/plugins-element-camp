...
class ElementCamp_Rotate_Box extends \Elementor\Widget_Base
{
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'rotate_option',
            [
                'label' => __('Rotate Option', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'st1' => __('Rotate Left', 'element-camp'),
                    'st2' => __('Rotate Right', 'element-camp'),
                ],
                'default' => 'st1',
            ]
        );
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Speed (s)', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 200,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-rotate-box .rotate-text' => ' animation-duration: {{SIZE}}s;',
                    '{{WRAPPER}} .tcgelements-rotate-box .rotate-text-reverse' => ' animation-duration: {{SIZE}}s;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'rotate_outline_type!' => ['', 'none'],
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-rotate-box' => 'outline-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-rotate-box' => 'outline-color: {{VALUE}};',
                ],
                'condition' => [
                    'rotate_outline_type!' => ['', 'none'],
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-rotate-box' => 'outline-offset: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'svg_outline',
            [
                'label' => esc_html__( 'SVG Outline', 'element-camp' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_control(
            'center_text_color_dark_mode',
            [
                'label' => esc_html__( 'Center Text Color (Dark Mode)', 'element-camp' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcgelements-rotate-box .center-text' => 'color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcgelements-rotate-box .center-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
