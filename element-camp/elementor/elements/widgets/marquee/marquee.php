...
class ElementCamp_Marquee extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'use_icon_image',
            [
                'label' => __('Use Icon Image', 'element-camp'),
        ...
        $repeater->add_control(
            'icon_image',
            [
                'label' => __('Icon Image', 'element-camp'),
        ...
        $repeater->add_control(
            'icon_image_align',
            [
                'label' => esc_html__('Icon Image Position', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'default' => 'left',
                'options' => [
                    'left' => esc_html__('Before', 'element-camp'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .tcg-marquee .main-marq .slide-har.st2 .box' => ' animation-duration: {{SIZE}}s;',
                    '{{WRAPPER}} .tcg-marquee .main-marq .slide-har.st3 .box' => ' animation-duration: {{SIZE}}s;',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box' => 'flex-direction: {{VALUE}}'
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box' => 'align-items: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item' => 'display: {{VALUE}};',
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item' => 'justify-content: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item' => 'align-items: {{VALUE}};',
                ],
                'condition'=>['item_display'=>'flex'],
                'responsive' => true,
            ]);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item' => '{{VALUE}}: blur({{item_blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient'],
                'exclude' => ['image'],
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item:hover',
            ]
        );

        $this->add_control(
            'text_container_transition',
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .item h4' => 'min-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'item_text_align',
            [
                'label' => esc_html__('Text Align', 'element-camp'),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => true,
                'default' => '',
                'options' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .item h4' => 'justify-content: {{VALUE}};',
                ],
                'condition' => [
                    'item_width[size]!' => '',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item h4' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            'text_gray_scale',
            [
                'label' => esc_html__( 'Text Gray Scale', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item h4' => 'filter: grayscale({{SIZE}});',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item:hover h4' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'text_gray_scale_hover',
            [
                'label' => esc_html__( 'Text Gray Scale', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item:hover h4' => 'filter: grayscale({{SIZE}});',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            'span_style_options',
            [
                'label' => esc_html__('Span', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'span_text_color',
                'label' => esc_html__('Text', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item h4 .text span',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item h4 .text span' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'container_icon_image_bg',
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item .icon-image',
                'types' => ['classic', 'gradient', 'tcg_gradient'],
            ]
        );

        $this->add_responsive_control(
            'container_icon_image_width',
            [
                'label' => esc_html__('Container Image Width', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .icon-image' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'container_icon_image_height',
            [
                'label' => esc_html__('Container Image Height', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'rem', 'em'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .icon-image' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'container_icon_image_margin',
            [
                'label' => esc_html__('Container Image Margin', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .icon-image' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'container_icon_image_padding',
            [
                'label' => esc_html__('Container Image Padding', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .icon-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'container_icon_image_border-radius',
            [
                'label' => esc_html__('Container Image Border Radius', 'element-camp'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .icon-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'container_icon_image_opacity',
            [
                'label' => esc_html__('Image Container Opacity', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img' => 'display: {{VALUE}};'
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img' => 'justify-content: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img' => 'align-items: {{VALUE}};',
                ],
                'condition'=>['image_container_display'=> ['flex','inline-flex']],
                'responsive' => true,
            ]);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before'
            ]
        );
        $this->start_controls_tabs(
            'image_container_style_tabs',
        );

        $this->start_controls_tab(
            'image_container_style_normal_tab',
            [
                'label'   => esc_html__('Normal', 'element-camp'),
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'types' => ['classic', 'gradient', 'tcg_gradient'],
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'image_container_style_dark_mode',
            [
                'label' => esc_html__('Dark Mode', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_control(
            'image_container_border_color_dark_mode',
            [
                'label' => esc_html__('Border Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-marquee .main-marq .box .item .img' => 'border-color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-marquee .main-marq .box .item .img' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'image_container_background_dark_mode',
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img',
                'types' => ['classic', 'gradient', 'tcg_gradient'],
                'fields_options' => [
                    'color' => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab(
            'image_container_style_hover_tab',
            [
                'label'   => esc_html__('Hover', 'element-camp'),
            ]
        );
        $this->add_control(
            'image_container_transition',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img' => 'transition: all {{SIZE}}s ease;',
                ],
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'image_container_background_color_hover',
                'types' => ['classic', 'gradient', 'tcg_gradient'],
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img:hover',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'image_container_border_hover',
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img:hover',
            ]
        );
        $this->add_control(
            'image_container_style_dark_mode_hover',
            [
                'label' => esc_html__('Dark Mode', 'element-camp'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_control(
            'image_container_border_color_dark_mode_hover',
            [
                'label' => esc_html__('Border Color', 'element-camp'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-marquee .main-marq .box .item .img:hover' => 'border-color: {{VALUE}};',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-marquee .main-marq .box .item .img:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'image_container_background_dark_mode_hover',
                'selector' => '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img:hover',
                'types' => ['classic', 'gradient', 'tcg_gradient'],
                'fields_options' => [
                    'color' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img img' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
                    '@media (prefers-color-scheme: dark){ body.tcg-auto-mode {{WRAPPER}} .tcg-marquee .main-marq .box .item .img img' => 'filter: invert({{SIZE}});',
                    '} body.tcg-dark-mode {{WRAPPER}} .tcg-marquee .main-marq .box .item .img img' => 'filter: invert({{SIZE}});',
                ],
            ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img img' => 'transition: all {{SIZE}}s ease;',
                    ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcg-marquee .main-marq .box .item .img:hover img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Letters Animation', 'element-camp'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => ['marque_option' => 'text'],
            ]
        );
        ...
        $this->add_control(
            'enable_letters_animation',
            [
                'label' => esc_html__('Enable Letters Animation', 'element-camp'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'element-camp'),
                'label_off' => esc_html__('No', 'element-camp'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'letters_animation_blur_amount',
            [
                'label' => esc_html__('Blur Amount', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'letters_animation_initial_scale',
            [
        ...
        $this->add_control(
            'letters_animation_start',
            [
                'label' => esc_html__('Start Position', 'element-camp'),
                'type' => Controls_Manager::TEXT,
                'default' => 'top 80%',
                'description' => esc_html__('ScrollTrigger start position (e.g., "top 80%", "top center")', 'element-camp'),
                'condition' => [
                    'enable_letters_animation' => 'yes',
                ],
                'frontend_available' => true,
    ...
    protected function render()
    {
        ...
        $wrapper_classes = ['tcg-marquee'];
        if ($settings['enable_letters_animation'] === 'yes') {
            $wrapper_classes[] = 'tce-letters-line';
        }

        $data_attrs = '';
        if ($settings['enable_letters_animation'] === 'yes') {
            $data_attrs .= ' data-letters-duration="' . esc_attr($settings['letters_animation_duration']['size']) . '"';
            $data_attrs .= ' data-letters-stagger="' . esc_attr($settings['letters_animation_stagger']['size']) . '"';
            $data_attrs .= ' data-letters-y-offset="' . esc_attr($settings['letters_animation_y_offset']['size']) . '"';
            $data_attrs .= ' data-letters-blur="' . esc_attr($settings['letters_animation_blur']) . '"';
            if ($settings['letters_animation_blur'] === 'yes') {
                $data_attrs .= ' data-letters-blur-amount="' . esc_attr($settings['letters_animation_blur_amount']['size']) . '"';
                $data_attrs .= ' data-letters-initial-scale="' . esc_attr($settings['letters_animation_initial_scale']['size']) . '"';
            }
