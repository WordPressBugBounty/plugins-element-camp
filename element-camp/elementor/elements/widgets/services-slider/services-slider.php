...
class ElementCamp_Services_Slider extends Widget_Base
{
    ...
    {
        return ['swiper','swiper-gl.min','simplex-noise','ogl.min','shaders','getGeometry','displacement','swiper-gl.esm','tcgelements-services-slider'];
    }
    ...
    protected function register_controls()
    {
        ...
        $slides_repeater->add_control(
            'link_placement',
            [
                'label' => esc_html__('Link Placement', 'element-camp'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'card' => esc_html__('Entire Card', 'element-camp'),
                    'button' => esc_html__('Button Only', 'element-camp'),
                ],
                'default' => 'card',
                'condition' => [
                    'button_switcher' => 'yes',
        ...
        $this->add_responsive_control(
            'swiper_slide_text_align',
            [
                'label' => esc_html__( 'Swiper Slide Alignment', 'element-camp' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-container .swiper-slide' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'section_slides_nth_swiper_slide_image_height_style_heading',
            [
        ...
        $this->start_controls_tabs(
            'style_nth_slides_swiper_slide_image_height_tabs'
        );
        ...
        $this->add_responsive_control(
            'nth_slides_swiper_slide_prev_2_image_height',
            [
                'label' => esc_html__('Image Height', 'element-camp'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide.swiper-slide-nth-prev-2 .card .icon img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'nth_slides_swiper_slide_next_2_image_height',
            [
                'label' => esc_html__('Image Height', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', 'rem', 'em', '%', 'custom'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide.swiper-slide-nth-next-2 .card .icon img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            'nth_slides_swiper_slide_prev_3_image_height',
            [
                'label' => esc_html__('Image Height', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', 'rem', 'em', '%', 'custom'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide.swiper-slide-nth-prev-3 .card .icon img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'nth_slides_swiper_slide_next_3_image_height',
            [
                'label' => esc_html__('Image Height', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', 'rem', 'em', '%', 'custom'],
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide.swiper-slide-nth-next-3 .card .icon img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'card_min_height',
            [
                'label' => esc_html__( 'Card Min Height', 'element-camp' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'unit' => 'px',
                ],
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => 'min-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => '{{VALUE}}: blur({{card_blur_value.SIZE}}px);',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->start_popover();
        $this->add_control(
            'card_transform_keep_proportions',
            [
                'label' => esc_html__('Keep Proportions', 'element-camp'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'card_transform_options' => 'yes',
                    'card_transform_keep_proportions!' => '',
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => '--e-transform-tcgelements-services-slider-card-scale: {{SIZE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'card_scaleX',
            [
                'label' => esc_html__('Scale X', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 2,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => '--e-transform-tcgelements-services-slider-card-scaleX: {{SIZE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'card_scaleY',
            [
                'label' => esc_html__('Scale Y', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 2,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => '--e-transform-tcgelements-services-slider-card-scaleY: {{SIZE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'card_scaleZ',
            [
                'label' => esc_html__('Scale Z (3D)', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 2,
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => '--e-transform-tcgelements-services-slider-card-scaleZ: {{SIZE}}',
                ],
            ]
        );
        $this->end_popover();
        $this->add_responsive_control(
            'card_transform_x_anchor_point',
            [
                'label' => esc_html__( 'X Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'element-camp' ),
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-x: {{VALUE}}',
                ],
            ]
        );

        $this->add_responsive_control(
            'card_transform_y_anchor_point',
            [
                'label' => esc_html__( 'Y Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
                        'title' => esc_html__( 'Top', 'element-camp' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-y: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'step' => 1,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => 'z-index: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->start_popover();
        $this->add_control(
            'active_card_translate_x',
            [
                'label' => esc_html__('Translate X', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-translateX: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            'active_card_translate_y',
            [
                'label' => esc_html__('Translate Y', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-translateY: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
            'active_card_transform_keep_proportions',
            [
                'label' => esc_html__('Keep Proportions', 'element-camp'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'element-camp'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'active_card_transform_options' => 'yes',
                    'active_card_transform_keep_proportions!' => '',
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-scale: {{SIZE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-scaleX: {{SIZE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-scaleY: {{SIZE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-scaleZ: {{SIZE}}',
                ],
            ]
        );
        $this->end_popover();
        $this->add_responsive_control(
            'active_card_transform_x_anchor_point',
            [
                'label' => esc_html__( 'X Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-x: {{VALUE}}',
                ],
            ]
        );

        $this->add_responsive_control(
            'active_card_transform_y_anchor_point',
            [
                'label' => esc_html__( 'Y Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-active .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-y: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
        $this->start_controls_tab(
            'prev_next_card_tab',
            [
                'label'   => esc_html__( 'Prev/Next', 'element-camp' ),
            ]
        );
        $this->add_control(
            'prev_next_card_z_index',
            [
                'label' => esc_html__( 'Z-Index', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 0,
                ...
                'step' => 1,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => 'z-index: {{VALUE}};',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => 'z-index: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->start_popover();
        $this->add_control(
            'prev_next_card_transform_keep_proportions',
            [
                'label' => esc_html__('Keep Proportions', 'element-camp'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'element-camp'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'prev_next_card_transform_options' => 'yes',
                    'prev_next_card_transform_keep_proportions!' => '',
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => '--e-transform-tcgelements-services-slider-card-scale: {{SIZE}}',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => '--e-transform-tcgelements-services-slider-card-scale: {{SIZE}}',
                ],
            ]
        );

        $this->add_responsive_control(
            'prev_next_card_scaleX',
            [
                'label' => esc_html__('Scale X', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => '--e-transform-tcgelements-services-slider-card-scaleX: {{SIZE}}',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => '--e-transform-tcgelements-services-slider-card-scaleX: {{SIZE}}',
                ],
            ]
        );

        $this->add_responsive_control(
            'prev_next_card_scaleY',
            [
                'label' => esc_html__('Scale Y', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => '--e-transform-tcgelements-services-slider-card-scaleY: {{SIZE}}',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => '--e-transform-tcgelements-services-slider-card-scaleY: {{SIZE}}',
                ],
            ]
        );

        $this->add_responsive_control(
            'prev_next_card_scaleZ',
            [
                'label' => esc_html__('Scale Z (3D)', 'element-camp'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => '--e-transform-tcgelements-services-slider-card-scaleZ: {{SIZE}}',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => '--e-transform-tcgelements-services-slider-card-scaleZ: {{SIZE}}',
                ],
            ]
        );
        $this->end_popover();
        $this->add_responsive_control(
            'prev_next_card_transform_x_anchor_point',
            [
                'label' => esc_html__( 'X Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                ...
                'separator' => 'before',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-x: {{VALUE}}',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-x: {{VALUE}}',
                ],
            ]
        );

        $this->add_responsive_control(
            'prev_next_card_transform_y_anchor_point',
            [
                'label' => esc_html__( 'Y Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-y: {{VALUE}}',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => '--e-transform-tcgelements-services-slider-card-transform-origin-y: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'prev_heading',
            [
                'label' => esc_html__( 'Previous Card Only', 'element-camp' ),
        ...
        $this->start_popover();
        $this->add_control(
            'prev_card_transform_keep_proportions',
            [
                'label' => esc_html__('Keep Proportions', 'element-camp'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'element-camp'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'prev_card_transform_options' => 'yes',
                    'prev_card_transform_keep_proportions!' => '',
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card' => '--e-transform-tcgelements-services-slider-card-scale: {{SIZE}}',
        ...
        $this->add_responsive_control(
            'prev_card_transform_x_anchor_point',
            [
                'label' => esc_html__( 'X Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
        ...
        $this->add_responsive_control(
            'prev_card_transform_y_anchor_point',
            [
                'label' => esc_html__( 'Y Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
        ...
        $this->add_control(
            'next_heading',
            [
                'label' => esc_html__( 'Next Card Only', 'element-camp' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_popover();
        $this->add_control(
            'next_card_transform_keep_proportions',
            [
                'label' => esc_html__('Keep Proportions', 'element-camp'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'element-camp'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'next_card_transform_options' => 'yes',
                    'next_card_transform_keep_proportions!' => '',
                ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card' => '--e-transform-tcgelements-services-slider-card-scale: {{SIZE}}',
        ...
        $this->add_responsive_control(
            'next_card_transform_x_anchor_point',
            [
                'label' => esc_html__( 'X Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
        ...
        $this->add_responsive_control(
            'next_card_transform_y_anchor_point',
            [
                'label' => esc_html__( 'Y Anchor Point', 'element-camp' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
        ...
        $this->start_controls_tab(
            'odd_even_card_tab',
            [
                'label'   => esc_html__( 'Odd/Even', 'element-camp' ),
            ]
        );
        ...
        $this->add_control(
            'even_card_heading',
            [
                'label' => esc_html__( 'Even Card', 'element-camp' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide:nth-of-type(even) .card' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            'odd_card_heading',
            [
                'label' => esc_html__( 'Odd Card', 'element-camp' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', 'rem'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide:nth-of-type(odd) .card' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            'title_split_text_animation',
            [
                'label' => esc_html__('Split Text Animation', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'element-camp'),
                'label_off' => esc_html__('Off', 'element-camp'),
                'return_value' => 'yes',
                'default' => 'no',
                'description' => esc_html__('Enable GSAP split text animation for titles. Requires GSAP and SplitText libraries.', 'element-camp'),
            ]
        );
        $this->add_control(
            'title_white_space',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'mobile_default' => 'yes',
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .title br' => 'display:none;',
                ],
            ]
        );
        ...
        $this->add_control(
            'title_span_heading',
            [
                'label' => esc_html__( 'Span Options', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .title span' => 'display: {{VALUE}};'
                ]
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Title', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcgelements-services-slider .card .title span',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .title span' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .title span' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .title span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            'title_small_heading',
            [
                'label' => esc_html__( 'Small Options', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Title', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcgelements-services-slider .card .title small',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .title small' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .title small' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .description' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            'description_split_text_animation',
            [
                'label' => esc_html__('Split Text Animation', 'element-camp'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'element-camp'),
                ...
                'return_value' => 'yes',
                'default' => 'no',
                'description' => esc_html__('Enable GSAP split text animation for descriptions. Requires GSAP and SplitText libraries.', 'element-camp'),
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'description_card_hover_typography',
                'label' => esc_html__('Description', 'element-camp'),
                'selector' => '{{WRAPPER}} .tcgelements-services-slider .card:hover .description',
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            'image_transition',
            [
                'label' => esc_html__( 'Image Container Transition', 'element-camp' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
        ...
        $this->start_controls_tab(
            'prev_next_card_image_container_tab',
            [
                'label'   => esc_html__( 'Prev/Next', 'element-camp' ),
            ]
        );
        ...
        $this->add_responsive_control(
            'prev_next_card_image_container_border_radius',
            [
                'label' => esc_html__( 'Image Container Border Radius', 'element-camp' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-prev .card .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide-next .card .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'prev_card_image_container_heading',
            [
                'label' => esc_html__( 'Previous Card Only', 'element-camp' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_responsive_control(
            'prev_card_image_container_border_radius',
            [
                'label' => esc_html__( 'Image Container Border Radius', 'element-camp' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'rem', 'custom' ],
        ...
        $this->add_control(
            'next_card_image_container_heading',
            [
                'label' => esc_html__( 'Next Card Only', 'element-camp' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_responsive_control(
            'next_card_image_container_border_radius',
            [
                'label' => esc_html__( 'Image Container Border Radius', 'element-camp' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'rem', 'custom' ],
        ...
        $this->end_controls_tab();
        $this->start_controls_tab(
            'odd_even_card_image_container_tab',
            [
                'label'   => esc_html__( 'Odd/Even', 'element-camp' ),
            ]
        );
        ...
        $this->add_control(
            'even_card_image_container_heading',
            [
                'label' => esc_html__( 'Even Card', 'element-camp' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_responsive_control(
            'even_card_image_container_border_radius',
            [
                'label' => esc_html__( 'Image Container Border Radius', 'element-camp' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide:nth-of-type(even) .card .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            'odd_card_image_container_heading',
            [
                'label' => esc_html__( 'Odd Card', 'element-camp' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_responsive_control(
            'odd_card_image_container_border_radius',
            [
                'label' => esc_html__( 'Image Container Border Radius', 'element-camp' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'rem', 'custom' ],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .swiper-slide:nth-of-type(odd) .card .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .icon img' => 'transition: all {{SIZE}}s ease;',
                ],
            ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .icon img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card:hover .icon img' => 'opacity: {{SIZE}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'card_image_hover_height',
            [
                'label' => esc_html__( 'Height', 'element-camp' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card:hover .icon img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .icon:before' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card:hover .icon:before' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card:hover .butn' => 'transform: translate({{button_translate_x_hover.SIZE}}{{button_translate_x_hover.UNIT}},{{button_translate_y_hover.SIZE}}{{button_translate_y_hover.UNIT}})',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .butn:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Background::get_type(),
            [
                'name' => 'button_btn_background_hover',
                'label' => esc_html__('Background', 'element-camp'),
                'types' => ['classic', 'gradient'],
                'exclude' => ['image'],
                'selector' => '{{WRAPPER}} .tcgelements-services-slider .card .butn:hover',
                'fields_options' => [
                    'background' => [
                        'default' => 'classic',
                    ],
        ...
        $this->add_group_control(
            Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'button_btn_box_shadow_hover',
                'selector' => '{{WRAPPER}} .tcgelements-services-slider .card .butn:hover',
            ]
        );
        $this->add_control(
            'button_btn_translate_y_hover',
            [
                'label' => esc_html__( 'Translate Y', 'element-camp' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'custom'],
        ...
        $this->add_control(
            'button_btn_translate_x_hover',
            [
                'label' => esc_html__( 'Translate X', 'element-camp' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .tcgelements-services-slider .card .butn:hover' => 'transform: translate({{button_btn_translate_x_hover.SIZE}}{{button_btn_translate_x_hover.UNIT}},{{button_btn_translate_y_hover.SIZE}}{{button_btn_translate_y_hover.UNIT}})',
                ],
            ]
        );
...
//        end
    ...
    protected function render()
    {
        ...
        $slider_settings = [
            ...
            'enableNthSlides' => $settings['enable_nth_slides'],
        ];
